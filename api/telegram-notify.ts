...
function formatContactMessage(data: Record<string, any>): string {
...
function formatNewUserMessage(data: Record<string, any>): string {
...
function formatUploadRequestMessage(data: Record<string, any>): string {
...
function formatNewRecitationMessage(data: Record<string, any>): string {
...
function formatQuestionMessage(data: Record<string, any>): string {
  return `❓ *NEW QUESTION*
